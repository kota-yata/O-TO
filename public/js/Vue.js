  ...
  template: `
    <div>
      ...
      <div>
        ...
        <p class="pb-3">
          僕は、作曲、アレンジ、楽器演奏、ミックスなどを全て一人で行ういわゆるマルチ・プレイヤーで、かれこれ20年以上音楽をやっています。<br>
          <br>
          まず、僕には音楽を作る中で「コレは創造的な作業とは言えないなぁ…。」と感じるものがたくさんありました。<br>
          <br>
          たとえば、編曲のためにコード流れや音の積み方を確認する作業や、エフェクト処理のために音価を計算する作業などです。<br>
          <br>
          もちろん、音楽に対して一定のクオリティを担保するためには、音楽理論的な視点からの検証が必要だと思います。<br>
          ただ、一度仕組みを理解してしまえば、これらの作業は非常に単純で退屈でもあります。<br>
          <br>
          ...
          むしろ、瞬時に答えが分かった方が試行錯誤する時間を多く確保できます。<br>
          <br>
          ...
          <br>
          「有名な〇〇さんも音楽理論は知らないって言ってたから…」→謙遜で言ってたり、編曲は別の人だったりする。
          <br>
          ...
          <br>
          そういった思いから「音楽制作や音楽理論の学習を補助するウェブアプリ」の目指して、この「<span class="MainTextColor">音楽理論ウェブアプリ
