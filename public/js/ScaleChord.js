...
function ChordsAndModeChange() {
    ...
    document.getElementById("Rel_MMaj_dia_3").innerHTML = `${noteNames[t4][9]} ${scale_Container[20]['diaChord4']}<br><font size="-2"><span class="avoid_note">♭9:${noteNames[t5][12]}</span>　(dim4:${noteNames[t8][17]})　♭13:${noteNames[tonic][2]}<br>${noteNames[t4][9]}${scale_Container[20][ScaleLanguage]}<br>(${noteNames[t4][9]}${scale_Container[60]['diaChord4']}オルタード)</font>`;
    ...
    document.getElementById("Para_MMin_dia_7").innerHTML = `${noteNames[t8][16]} ${scale_Container[20]['diaChord4']}<font size="-2"><br><span class="avoid_note">♭9:${noteNames[t9][18]}</span>　(dim4:${noteNames[tonic][2]})　♭13:${noteNames[t4][9]}<br>${noteNames[t8][16]}${scale_Container[20][ScaleLanguage]}<br>(${noteNames[t8][16]}${scale_Container[60]['diaChord4']}オルタード)</font>`;
