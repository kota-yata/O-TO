...
function ChordsAndModeChange() {
    ...
    document.getElementById("Rel_HMin_dia_5").innerHTML = `${noteNames[t8][16]} ${scale_Container[13]['diaChord4']}<br><font size="-2">♭9:${noteNames[t9][18]}　(dim4:${noteNames[tonic][2]})　♭13:${noteNames[t4][9]}<br>${noteNames[t8][16]}${scale_Container[13][ScaleLanguage]}</font>`;
    ...
    document.getElementById("Rel_MMin_dia_3").innerHTML = `${noteNames[t4][9]} ${scale_Container[18]['diaChord4']}<font size="-2"><br>9:${noteNames[t6][13]}　11:${noteNames[t9][18]}　<span class="avoid_note">♭13:${noteNames[tonic][2]}</span><br>${noteNames[t4][9]}${scale_Container[18][ScaleLanguage]}<br>(${noteNames[t4][9]}メロディック・メジャー)</font>`;
    ...
    document.getElementById("Rel_MMin_dia_5").innerHTML = `${noteNames[t8][16]} ${scale_Container[20]['diaChord4']}<font size="-2"><br>♭9:${noteNames[t9][18]}　(dim4:${noteNames[tonic][2]})　♭13:${noteNames[t4][9]}<br>${noteNames[t8][16]}${scale_Container[20][ScaleLanguage]}<br>(${noteNames[t8][16]}${scale_Container[60]['diaChord4']}オルタード)</font>`;
    ...
    document.getElementById("Rel_HMaj_dia_3").innerHTML = `${noteNames[t4][9]} ${scale_Container[23]['diaChord4']}<br><font size="-2"><span class="avoid_note">♭9:${noteNames[t5][12]}</span>　(dim4:${noteNames[t8][17]})　<span class="avoid_note">♭13:${noteNames[tonic][2]}</span><br>${noteNames[t4][9]}${scale_Container[23][ScaleLanguage]}</font>`;
    ...
    document.getElementById("Rel_MMaj_dia").innerHTML = `${noteNames[tonic][SOF]} メロディック・メジャー：${sharp_key_signature[tonic]}`;
    document.getElementById("Rel_MMaj_dia_1").innerHTML = `${noteNames[tonic][2]} ${scale_Container[28]['diaChord4']}<br><font size="-2">9:${noteNames[t2][5]}　11:${noteNames[t5][12]}　<span class="avoid_note">♭13:${noteNames[t8][17]}</span><br>${noteNames[tonic][2]}${scale_Container[28][ScaleLanguage]}</font>`;
    ...
    document.getElementById("Para_HMin_dia_7").innerHTML = `${noteNames[t8][16]} ${scale_Container[13]['diaChord4']}<br><font size="-2">♭9:${noteNames[t9][18]}　(dim4:${noteNames[tonic][2]})　♭13:${noteNames[t4][9]}<br>${noteNames[t8][16]}${scale_Container[13][ScaleLanguage]}</font>`;
