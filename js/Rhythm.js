...
function NoteLength2() {
    ...
    if (input_bpm > 0) {
        ...
        document.getElementById("time_quarter_note_triplet").innerHTML = "2拍3連<br><img src='./image/note/HarfNoteTriplets.svg' alt='2拍3連' title='2拍3連' class='note_image'><br>" + roundToThree(time_quarter_note_triplet) + String(time_unit);
        document.getElementById("time_8th_note_tuplet").innerHTML = "1拍3連<br><img src='./image/note/QuarterNoteTriplets.svg' alt='1拍3連' title='1拍3連' class='note_image'><br>" + roundToThree(time_8th_note_tuplet) + String(time_unit);
        document.getElementById("time_16th_note_tuplet").innerHTML = "1拍6連<br><img src='./image/note/QuarterNoteSextuplet.svg' alt='1拍6連符' title='1拍6連符' class='note_image'><br>" + roundToThree(time_16th_note_tuplet) + String(time_unit);
        ...
        document.getElementById("time_maxima").innerHTML = "マキシマ<br><img src='./image/note/Maxima.svg' alt='マキシマ' title='マキシマ' class='note_image'><br>" + roundToThree(time_maxima) + String(time_unit);
        document.getElementById("time_longa").innerHTML = "ロンガ<br><img src='./image/note/Longa.svg' alt='ロンガ' title='ロンガ' class='note_image'><br>" + roundToThree(time_longa) + String(time_unit);
        ...
        document.getElementById("time_quarter_note_quintuplet").innerHTML = "1拍5連<br><img src='./image/note/QuarterNoteQuintuplet.svg' alt='1拍5連符' title='1拍5連符' class='note_image'><br>" + roundToThree(time_quarter_note_quintuplet) + String(time_unit);
        document.getElementById("time_half_note_triplet").innerHTML = "4拍3連<br><img src='./image/note/WholeNoteTriplets.svg' alt='4拍3連' title='4拍3連' class='note_image'><br>" + roundToThree(time_half_note_triplet) + String(time_unit);
...
function NoteInfo() {
    ...
    if (note_count <= 0 || rhythm_input_bpm <= 0) {
        ...
        document.getElementById("same_length_half_note_triplet").innerHTML = "4拍3連<br><img src='./image/note/WholeNoteTriplets.svg' alt='4拍3連' title='4拍3連' class='note_image'><br>BPM=" + roundToThree(Number(one_minutes) / ((Number(note_value) * 3) / 4));
        ...
        document.getElementById("same_length_quarter_note_triplet").innerHTML = "2拍3連<br><img src='./image/note/HarfNoteTriplets.svg' alt='2拍3連' title='2拍3連' class='note_image'><br>BPM=" + roundToThree(Number(one_minutes) / ((Number(note_value) * 6) / 4));
        ...
        document.getElementById("same_length_8th_note_tuplet").innerHTML = "1拍3連<br><img src='./image/note/QuarterNoteTriplets.svg' alt='1拍3連' title='1拍3連' class='note_image'><br>BPM=" + roundToThree(Number(one_minutes) / ((Number(note_value) * 12) / 4));
        ...
        document.getElementById("same_length_quarter_note_quintuplet").innerHTML = "1拍5連<br><img src='./image/note/QuarterNoteQuintuplet.svg' alt='1拍5連符' title='1拍5連符' class='note_image'><br>BPM=" + roundToThree(Number(one_minutes) / ((Number(note_value) * 20) / 4));
        document.getElementById("same_length_16th_note_tuplet").innerHTML = "1拍6連<br><img src='./image/note/QuarterNoteSextuplet.svg' alt='1拍6連符' title='1拍6連符' class='note_image'><br>BPM=" + roundToThree(Number(one_minutes) / ((Number(note_value) * 24) / 4));
